...
import ProjectTable from "../../admin/projects/project-table";
...
const DevelopersProjects = () => (
  <>
    <SEOMeta
      ...
      title="Developer Projects - Staron AI"
    />

    <main>
      <ProjectTable type="all" mode="developer" />
    </main>
  </>
);

export default DevelopersProjects;
